    ...
    <div v-else>
          ...
          <table class="reports-table">
            ...
            <tbody>
              <tr v-for="q in quarterlyData" :key="q.quarter">
                ...
                <td>{{ q.total_orders.toLocaleString(currentLocale === 'ja' ? 'ja-JP' : 'en-US') }}</td>
          ...
          <table class="reports-table">
            ...
            <tbody>
              <tr v-for="(month, index) in monthlyData" :key="month.month">
                ...
                <td>{{ month.order_count.toLocaleString(currentLocale === 'ja' ? 'ja-JP' : 'en-US') }}</td>
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-value">{{ totalOrders.toLocaleString(currentLocale === 'ja' ? 'ja-JP' : 'en-US') }}</div>
        </div>
        <div class="stat-card">
...
export default {
  ...
  setup() {
    ...
    // Computed summary stats derived from raw data refs
    ...
    // Pre-computed max revenue to avoid recalculating on every bar render
    ...
    // Locale-aware month formatter (input: "YYYY-MM")
    ...
    // Max height 200px, proportional to maxRevenue
    ...
    // Returns formatted change string e.g. "+$500.00" or "-$200.00"
